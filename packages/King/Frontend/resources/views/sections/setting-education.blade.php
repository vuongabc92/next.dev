<section>
    <div class="_fwfl timeline-container">
        <div class="timeline" data-update-employment data-remove-employment>
                ...
                @foreach($employmentHistories as $employment)
                    <div class="_fwfl timeline-section" id="timeline-section-{{ $employment->id }}">
                        ...
                        <div class="timeline-content">
                            ...
                            <button class="btn _btn timeline-btn timeline-remove" data-remove-employment-id="{{ $employment->id }}" data-confirm-msg="Are you sure to remove it?"><i class="fa fa-remove"></i></button>
                        </div>
                    </div>
                @endforeach
            @endif
