...
@section('body')
    ...
    <div class="_fwfl _mt20">
        {!! Form::open(['route' => 'back_page_savecontact', 'method' => 'post', 'files' => true]) !!}
            @if (session('success'))
            ...
            @endif
            <div class="form-group">
                <img src="/{{ $contact->getBannerImage() }}" alt="{{ $contact->name }}" class="img-thumbnail">
                <hr>
            </div>
            <div class="form-group">
                <label>Banner</label>
            ...
            <div class="form-group">
                {!! Form::text('name', $contact->name, ['class' => 'form-control', 'placeholder' => 'Page name']) !!}
            </div>
            <div class="form-group">
