...
@section('body')
    ...
    <div class="_fwfl _mt20">
        {!! Form::open(['route' => 'back_page_saveterms', 'method' => 'post', 'files' => true]) !!}
            @if (session('success'))
            ...
            @endif
            <div class="form-group">
                <img src="/{{ $terms->getBannerImage() }}" alt="{{ $terms->name }}" class="img-thumbnail">
                <hr>
            </div>
            <div class="form-group">
                <label>Banner</label>
            ...
            <div class="form-group">
                {!! Form::text('name', $terms->name, ['class' => 'form-control', 'placeholder' => 'Page name']) !!}
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <textarea name="content" class="form-control">{{ $terms->content }}</textarea>
            </div>
            <div class="form-group">
